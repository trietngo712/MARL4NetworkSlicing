    ...
    def step(self, actions):
        ...
        for agent, action in items:
            ...
            for idx, resource_id in enumerate(slice.idx_to_resource):
                ...
                if demand[resource_id] == 0:
                    resource_allocation = 0
                
                recorder.add_allocation(resource_id, resource_allocation)
                
                duration = demand[resource_id] / resource_allocation if resource_allocation != 0 else -1
...
class Recorder():
    def __init__(self, slice):
        ...
        self.availability = {resource: [] for resource in self.idx_to_resource}
        
    
    def add_availability(self, id, availability):
        self.availability[id].append(availability)
