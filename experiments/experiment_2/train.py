...
from torchrl.collectors import Collector, RandomPolicy # This is a class for collecting data synchronously from an environment, which can be used for training reinforcement learning agents.
...
def main():
    ...
    #            sigma_init=0.2,  # Initial value of the sigma
    #            sigma_end=0.02,  # Final value of the sigma
    #        ),
    #    )
    ...
    if flattened_data:
        ...
        save_path = os.path.join(args.log_path, 'incomplete_transitions.csv')
